...
public class T2bucles6 {
	...
	public static void main(String args[]) {
		...
		System.out.println();
		System.out.println("Porcentaje alquiladas 20 veces: " + por_alq20 + "%");
		System.out.println("Porcentaje alquiladas 5 veces: " + por_alq5 + "%");
		System.out.println("Porcentaje alquiladas entre 7 y 15 veces: "+ por_alq7y15 + "%");

		System.out.println();
		System.out.println("Cod peli menos alq: " + cod_menos_alq);
		
		System.out.println();
		System.out.println("Media de veces alquilada: " + media);
}
}
